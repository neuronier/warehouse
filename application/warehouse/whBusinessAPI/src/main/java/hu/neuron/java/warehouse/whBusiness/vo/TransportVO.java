...
public class TransportVO implements Serializable{
	 ...
	 * A termékek
	 */
	private Collection<WareVo> wares;
	...
	public Collection<WareVo> getWares() {
		return wares;
	}

	public void setWares(Collection<WareVo> wares) {
		this.wares = wares;
	}

	@Override
	public String toString() {
		return "TransportVO [fromWarehouseId=" + fromWarehouseId
				+ ", toWarehouseId=" + toWarehouseId + ", fromWarehouseName="
				+ fromWarehouseName + ", fromWarehouseZipCode="
				+ fromWarehouseZipCode + ", fromWarehouseCity="
				+ fromWarehouseCity + ", fromWarehouseAddress="
				+ fromWarehouseAddress + ", fromWarehouseAddressNumber="
				+ fromWarehouseAddressNumber + ", fromWarehouseUserName="
				+ fromWarehouseUserName + ", fromWarehouseUserPhone="
				+ fromWarehouseUserPhone + ", fromWarehouseUserEmail="
				+ fromWarehouseUserEmail + ", toWarehouseName="
				+ toWarehouseName + ", toWarehouseZipCode="
				+ toWarehouseZipCode + ", toWarehouseCity=" + toWarehouseCity
				+ ", toWarehouseAddress=" + toWarehouseAddress
				+ ", toWarehouseAddressNumber=" + toWarehouseAddressNumber
				+ ", toWarehouseUserName=" + toWarehouseUserName
				+ ", toWarehouseUserPhone=" + toWarehouseUserPhone
				+ ", toWarehouseUserEmail=" + toWarehouseUserEmail
				+ ", itemName=" + itemName + ", articleNumber=" + articleNumber
				+ ", piece=" + piece + ", transportStatus=" + transportStatus
				+ ", wares=" + wares + "]";
	}
